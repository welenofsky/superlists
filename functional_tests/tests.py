...
class NewVisitorTest(StaticLiveServerTestCase):
	...
	def test_can_start_a_list_and_retrieve_it(self):
		...
		# Keys.ENTER on a non-mac computer <.<
		...
		## We use a new browser session to ensure none of ediths informations comes through from cookies etc
		self.browser.quit()
		self.browser = webdriver.Firefox()
		...
		# Francis starts a new list, Francis isn't as interesting as Edith
		inputbox = self.browser.find_element_by_id('id_new_item')
		...
		# Again there is no evidence of Ediths list
		page_text = self.browser.find_element_by_tag_name('body').text
